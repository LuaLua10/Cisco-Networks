...
![](media/073df55cf8a38993656a3674567e11e.png)
...
> Для провайдера Триада параллельно настроим IGP (OSPF). R23 будит выступать в роле route-reflector.
...
> R18 будит выступать в роле route-reflector. На R16 и R17 порты e0/0 и e0/2 обьединим в Bridge и созданим BVI интерфейсы. 
